...
/** TODO load json from resource, not yet sure how to do that in compose preview **/
fun loadSampleSpells(): List<Spell> {
	val json = Json {
		isLenient = true
		ignoreUnknownKeys = true
	}
	return json.decodeFromString<SpellList>(sampleJson).spells
}
				...
				"entries": [
					"You magically empower your movement with dance-like steps, giving yourself the following benefits for the duration.",
					{
						...
						"items": [
							...
							"You can move through the space of another creature, and it doesn't count as difficult terrain. If you end your turn in another creature's space, you are shunted to the last unoccupied space you occupied, and you take {@damage 1d8} force damage."
						]
					}
				],
				"damageInflict": [
				...
				"entriesHigherLevel": [
					{
						...
						"name": "At Higher Levels",
						"entries": [
							"When you cast this spell using a spell slot of 3rd level or higher, the damage increases by {@dice 1d6} for each slot above the 2nd, and the number of Hit Dice that can be spent and added to the healing roll increases by one for each slot above 2nd."
						]
					}
				],
				"damageInflict": [
